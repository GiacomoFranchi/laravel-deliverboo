...
@section('content')
    <div class="container">
        ...
        <div class="mb-3">
            <label for="restaurantFilter" class="form-label">Filtra per Ristorante:</label>
            <select class="form-select" id="restaurantFilter" name="restaurantFilter">
                    ...
                    @foreach ($orders as $order)
                        <tr>
                            ...
                            <td><a class="btn btn-success"
                                    href="{{ route('admin.orders.show', ['order' => $order->slug]) }}">Dettagli</a></td>
                        </tr>
                    @endforeach
